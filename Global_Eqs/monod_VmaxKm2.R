monod_VmaxKm2<-function(data){
  ...
  estim<-function(fr){
    ...
    est<-function(x){
      ...
      yhat<-x[1]*exp(x[3]/8.314/Temp)*Ctot*Cmic/(x[2]*exp(x[4]/8.314/Temp)+Ctot)
    ...
    par_mcmc<-modMCMC(f=est, p=c(1, 30, -60000, -60000),
                      lower=c(1e-30, 3e-6, -300000, -300000),
                      upper=c(1e30, 30000, 30000, 30000), niter=50000)
